...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { address: @agency.address, email: @agency.email, gsm: @agency.gsm, name: @agency.name, phone: @agency.phone }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { address: @agency.address, email: @agency.email, gsm: @agency.gsm, name: @agency.name, phone: @agency.phone }
    assert_redirected_to agency_path(assigns(:agency))
  end
